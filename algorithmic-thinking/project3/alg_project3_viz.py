...
def create_dictionary(data_table):

    cluster_dictionary = dict()
    

    for line in data_table:
        cluster = alg_cluster.Cluster(set([line[0]]), line[1], line[2], line[3], line[4])
        cluster_dictionary[line[0]] = cluster
...
def compute_distortion(cluster_list, data_table):
    ...
    for cluster in cluster_list:
        ...
        #for sub_cluster_code in cluster.fips_codes():
        #    sub_cluster = dictionary[sub_cluster_code]
        #    cluster_distortion += cluster.distance(sub_cluster)

        #cluster_distortion_list.append(cluster_distortion)

    #total_distortion = 0
    #for distortion in cluster_distortion_list:
